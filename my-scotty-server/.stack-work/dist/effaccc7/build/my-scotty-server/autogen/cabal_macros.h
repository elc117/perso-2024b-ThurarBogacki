...
/* package my-scotty-server-0.1.0.0 */
#ifndef VERSION_my_scotty_server
#define VERSION_my_scotty_server "0.1.0.0"
#endif /* VERSION_my_scotty_server */
#ifndef MIN_VERSION_my_scotty_server
#define MIN_VERSION_my_scotty_server(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_my_scotty_server */
...
#define CURRENT_COMPONENT_ID "my-scotty-server-0.1.0.0-JbUfvQ1drkCHm7adcGi6a-my-scotty-server"
